...
import una.examengrupo3.controller.Controller;
...
public class FlowController {
    ...
    public void goMain() {
        try {
            this.mainStage.setScene(new Scene(FXMLLoader.load(App.class.getResource("view/Primary.fxml"), this.idioma)));
            this.mainStage.show();
            ...
            this.mainStage.setTitle("Examen Final");
